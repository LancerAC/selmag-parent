...
import com.example.managerapp.web.controller.ProductController;
import com.example.managerapp.web.payload.UpdateProductPayload;
...
class ProductControllerTest {
    ...
    void handleNoSuchElementException_Returns404ErrorPage() {
        ...
        doReturn("Ошибка").when(this.messageSource)
                .getMessage("error", new Object[0], "error", Locale.forLanguageTag("ru"));
        ...
        verify(this.messageSource).getMessage("error", new Object[0], "error", Locale.forLanguageTag("ru"));
